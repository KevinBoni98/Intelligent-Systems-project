...
for dataset_path in "${dataset_paths[@]}"; do
  ...
  # 3) Rinomina PDF come richiesto e inseriscilo nella cartella pdfs/data_exploration_results
  mkdir -p pdfs/data_exploration_results
  mv "output_${folder_name}.pdf" "pdfs/data_exploration_results/$pdf_name"
